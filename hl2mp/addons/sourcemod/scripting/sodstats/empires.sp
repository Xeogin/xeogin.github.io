// File:   sodstats.empires.sp
// Author: ]SoD[ Frostbyte

#define DIR_EMPIRES        "empires"
#define ID_EMPIRES         216

HookEventsEmpires()
{
	HookEvent("player_death", Event_Empires_PlayerDeath);
}

public Event_Empires_PlayerDeath(Handle:event, const String:name[], bool:dontBroadcast)
{
