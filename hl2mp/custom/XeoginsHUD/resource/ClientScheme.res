...
Scheme
{
	...
	Colors
	{
		...
		//Blue	"0 175 255 255"
		//Orange	"255 160 10 255"
		
		"HudBackground"	"0 0 0 150" // (HUD Background Color)
		"HudColor_1"	"0 175 255 255" // (Health+SecondaryAmmo+WeaponSelectionText Color)
		"HudColor_2"	"255 255 255 255"	// (Suit+Ammo Color)

		"AuxPowerColor"	"255 255 255 255" // (SuitAuxPower Color)
	

		"SB_TextColor"	"255 25 25 255" // (ScoreBoard "Kills Deaths Ping" Text Color)
		"SB_DeviderColor"	"0 0 0 255" // (ScoreBoard Dividing Line Color)

		"SB_NNBgColor"	"255 255 255 25" // (ScoreBoard NickName Background Color)
	...
	BaseSettings
	{
		...
		"Panel.FgColor"			"ColorTwo"
		"Panel.BgColor"			"0 0 0 0"
		
		"BrightFg"		"255 255 255 255"

		"DamagedBg"			"220 0 0 200"
		"DamagedFg"			"220 0 0 230"
		...
		"SelectionBoxBg" 		"0 0 0 100"
		"SelectionSelectedBoxBg" "0 0 0 130"
		
		"ZoomReticleColor"	"255 255 255 255"

		// HL1-style HUD colors
		"Yellowish"			"255 255 255 255"
		"Normal"			"255 255 255 255"
		"Caution"			"255 15 15 255"
...
///HERE
		...
		Border.Bright					"TransparentBlack"		// the lit side of a control
		Border.Dark						"TransparentBlack"		// the dark/unlit side of a control
		...
		SectionedListPanel.HeaderTextColor	"SB_TextColor"
		SectionedListPanel.HeaderBgColor	"Blank"
		SectionedListPanel.DividerColor		"SB_DeviderColor"
		SectionedListPanel.TextColor		"Orange"
		SectionedListPanel.BrightTextColor	"Orange"
		SectionedListPanel.BgColor			"SB_BgColor"
		SectionedListPanel.SelectedTextColor			"Black"
		SectionedListPanel.SelectedBgColor				"Red"
		SectionedListPanel.OutOfFocusSelectedTextColor	"Black"
		SectionedListPanel.OutOfFocusSelectedBgColor	"SB_NNBgColor"
	...
	Fonts
	{
		SpecBarPlayerLabel //thx to asf. aka nertzy aka Javek
		{
			"1"
			{
				"name"		"Russo One"
		...
		"TargetID" //Players name text when hovering with crosshair
		{
			"1"
			{
				"name"		"Trebuchet MS"
		...
		CSTypeDeath			// JANEK_0001
		{
		   "1"
		   {
			"name"  "PDeathIcon" // csd.ttf
			"tall"  "42"
			"weight" "0"
			"additive" "0"
			"antialias" "1"
	...
	CustomFontFiles
	{
		...
		"3"		"resource/fonts/PDeathIcon.ttf"
		"4"		"resource/fonts/NeoSansPro-BoldItalic.otf"
		"5"		"resource/fonts/XHAIR.ttf"
		"6"		"resource/fonts/Russo_One.ttf"
		"7"		"resource/fonts/DS-DigitalBoldIT.ttf"
		"8"		"resource/fonts/WeaponIcons.ttf"
		"9"		"resource/fonts/Icons.ttf"
		"10"	"resource/fonts/HUD_Numbers.ttf"
	}
